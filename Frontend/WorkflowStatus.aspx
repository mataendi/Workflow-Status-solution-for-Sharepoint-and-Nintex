<asp:Content ContentPlaceHolderId="Your_ID" runat="server"> 
  ...
  <script src="https://servername/js/JS_Library/scripts/myCustomLibrary.js"></script>
 ...
 <script type="text/javascript">
    ...
    getUserProfileProperties(function(result) {
        ...
        script.src = `https://sharepointSiteURL/_catalogs/masterpage/customData/workflowHistory/wfStatus_${country}.js`;
        ...
        script.onerror = function() {
            ...
            fallbackScript.src = 'https://sharepointSiteURL/_catalogs/masterpage/customData/workflowHistory/wfStatus_de.js';
